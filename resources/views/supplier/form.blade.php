<div class="modal" id="modal-form" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
 ...
 <div class="modal-body">
    ...
    <div class="form-group">
       <label for="name_supplier" class="col-md-3 control-label">Nama Supplier</label>
       <div class="col-md-6">
          <input id="name_supplier" type="text" class="form-control" name="name_supplier" autofocus required>
