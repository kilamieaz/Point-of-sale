        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" data-toggle="validator" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="id_expenses" name="id_expenses">
                    <div class="form-group">
                        <label for="type_expenses" class="col-md-3 control-label">Jenis Pengeluaran</label>
                        <div class="col-md-8">
                            <input id="type_expenses" type="text" class="form-control" name="type_expenses" autofocus
                                required>
